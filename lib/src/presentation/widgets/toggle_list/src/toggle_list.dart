...
import 'package:course_selection_system/src/presentation/widgets/toggle_list/src/toggle_list_data.dart';
...
class _ToggleListState extends State<ToggleList> {
  ...
  void initState() {
    ...
    _listController = ToggleListController(sectionsLeftExpanded: widget.sectionsLeftExpanded);
    super.initState();
  }
