...
class _ToggleListItemState extends State<ToggleListItem> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    _isExpanded = PageStorage.of(context).readState(context) as bool? ?? widget.isInitiallyExpanded;
    super.initState();
  }
          ...
          children: [
            InkWell(
              ...
              child: AnimatedContainer(
                curve: data.curve,
                duration: data.toggleAnimationDuration,
                decoration: _isExpanded ? widget.expandedHeaderDecoration ?? widget.headerDecoration : widget.headerDecoration,
                child: Row(
